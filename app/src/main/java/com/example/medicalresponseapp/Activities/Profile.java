...
public class Profile extends AppCompatActivity {
    ...
    String userID, stringID, id, name, surname, emailAddress,
            homeAddress, meterNumber, newName, email, address, gender, newAddress, newGender,
...
//        editProfileDialog = new Dialog(Profile.this);
...
//        btnCancelLogout = logout_dialog.findViewById(R.id.btnCancelLogout);
        ...
        profileRef.getDownloadUrl().addOnSuccessListener(uri -> {
            ...
            Picasso.with(Profile.this).load(uri).into(ivProfilePhotoChange);
        ...
        ivBack.setOnClickListener(v -> Profile.this.finish());
